...
<!--=====================BODY======================-->
<button style="	float: left; width: 50%; height: 50px; background-color: #DB53FB;" onclick="showMyPlaylist()">My Playlist</button>
...
<div id="myPlaylist" style="display: block;">
<?php
$connection = mysqli_connect("localhost", "ageorgiou4","BgbW8708", "ageorgiou4");
...
<div id="randomPlaylist" style="display: none;">
